...
2. **[Modelo de Datos Relacional](02_modelo_datos_relacional.md):** Diseño conceptual y físico orientado a PostgreSQL. Detalla el diccionario de datos de las tablas físicas y la justificación del modelo híbrido relacional/dinámico utilizado para campos dinámicos y la carga de ficheros.
...
## Stack Tecnológico Propuesto (Fase 2)
